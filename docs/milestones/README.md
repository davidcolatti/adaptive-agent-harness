...
| M3, Jev as a First-Class Decision Primitive | complete (snapshot: [../progress/milestones/m3.md](../progress/milestones/m3.md)) | [m3-jev-as-a-first-class-decision-primitive.md](m3-jev-as-a-first-class-decision-primitive.md) |
...
| M5, Workflow Registry, Router, and Fallback | complete (snapshot: [../progress/milestones/m5.md](../progress/milestones/m5.md)) | [m5-workflow-registry-router-and-fallback.md](m5-workflow-registry-router-and-fallback.md) |

Later milestones (M6 onward) get their own status file when that milestone starts. Creating them
